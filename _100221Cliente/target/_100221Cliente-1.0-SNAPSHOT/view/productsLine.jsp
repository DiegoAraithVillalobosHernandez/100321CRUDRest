...
<head>
    ...
    <title>Inicio | Línea de Productos</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="./regUpdProdLine.jsp">Registrar | Actualizar</a>
                </li>
            </ul>
            ...
            <div class="row p-2">
                <div class="col-12 col-md-8">
                    <div class="form-group">
                        <label for="productLine">Búsqueda por línea de producto: </label>
